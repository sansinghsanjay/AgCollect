...
{
    //http://api.openweathermap.org/data/2.5/weather?lat=19.1260175&lon=73.015622&APPID=95d65f6aaeda48cf807a37c825850a1b

    private static final String OPEN_WEATHER_MAP_URL =
            "http://api.openweathermap.org/data/2.5/weather?lat=%s&lon=%s&units=metric";

    private static final String OPEN_WEATHER_MAP_API = "95d65f6aaeda48cf807a37c825850a1b";
    ...
    public static String setWeatherIcon(int actualId, long sunrise, long sunset){
        ...
        if(actualId == 800){
            ...
            Log.v("time-", String.valueOf(currentTime));
